...
[
  ...
  },
  {
    ...
    "Poster": "https://m.media-amazon.com/images/M/MV5BNzY2M2IzNWMtMWFkMS00ODk1LWI3NGYtNTBiYTc5MTA0Y2YzXkEyXkFqcGdeQXVyNDA5NTgxNjU@._V1_FMjpg_UX1000_.jpg",
    "Ratings": [
      {
        "Source": "Internet Movie Database",
        "Value": "7.3/10"
  ...
  return (
    <SafeAreaView style={backgroundStyle}>
      ...
      <FlatList style={{marginBottom:50}}
        data={moviesData}
        renderItem={({item}) => (
          <View style={{borderWidth: 2, borderColor: 'gray', margin:10}}>
            <Text style={{fontSize:20, fontWeight:'bold', color:'gray', marginLeft:10, marginTop:10}}>#{item.id}</Text>
            <Image
              style={{width:'95%', resizeMode:'contain', alignSelf:'center', margin:10}}
              source={{
                uri: item.Poster,
              }}
            />
            ...
            <Text style={styles.text1}>
              <Text style={styles.boldText}>Year: </Text>{item.Year}
            </Text>
            <Text style={styles.text1}>
              <Text style={styles.boldText}>Genre: </Text>{item.Genre}
            </Text>
            <Text style={styles.text1}>
              <Text style={styles.boldText}>IMDB: </Text>{item.imdbRating}
            </Text>
            <Text style={styles.text1}>
              <Text style={styles.boldText}>Desc: </Text>{item.Plot}
            </Text>
